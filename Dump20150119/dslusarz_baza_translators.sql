...
CREATE TABLE `translators` (
  ...
  `translator_name` tinytext COLLATE utf8_bin,
  `translator_surname` tinytext COLLATE utf8_bin,
...
INSERT INTO `translators` VALUES (1,'Jan','Kraśko'),(2,'Monika','Faryna-Lubecka'),(3,'Anna','Jakubowska'),(5,'imiet','nazwiskot'),(6,'Izabela','Wiśniewska-Repeczko'),(7,'Witold','Wroczyński'),(9,'Michał','Nowakowski');
...
-- Dump completed on 2015-01-19 21:54:57
