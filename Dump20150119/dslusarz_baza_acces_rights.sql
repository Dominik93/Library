...
CREATE TABLE `acces_rights` (
  `acces_right_id` int(11) NOT NULL AUTO_INCREMENT,
  `acces_right_name` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`acces_right_id`)
...
INSERT INTO `acces_rights` VALUES (1,'admin'),(2,'activeReader'),(3,'disactiveReader');
...
-- Dump completed on 2015-01-19 21:54:44
