...
CREATE TABLE `house_numbers` (
  `house_number_id` int(11) NOT NULL AUTO_INCREMENT,
  `house_number_name` varchar(6) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `house_numbers` VALUES (1,'22/5'),(4,'15/88'),(9,'84/1');
...
-- Dump completed on 2015-01-19 21:54:32
